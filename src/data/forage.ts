...
// Map raw OpenStreetMap tag values onto our forage keys.
export const TAG_TO_FORAGE_KEY: Record<string, ForageKey> = {
  orchard: 'orchard',
  meadow: 'meadow',
  farmland: 'farmland',
...
export const CONFIDENCE_WEIGHTS: Record<Confidence, number> = { observed: 1.5, surveyed: 1.25, openStreetMap: 1 }

export const RING_KILOMETRES = [1, 3, 5]
export const MAX_MARKERS = 150

// Queen mating flight radius. Queens fly to drone congregation areas typically
// 2-3 km from the hive; those areas sit up to ~5 km out, and genetic paternity work
...
export const MATING_RADIUS_KILOMETRES = 5
